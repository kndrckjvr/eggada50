...
boards="eggada50_wireless eggada50"
...
do
    ...
    if [ -e pcbs/${board}.kicad_pcb ]; then
        echo Export DSN 
        ${container_cmd} run ${container_args} ${kicad_auto_image} python3 kibot/export_dsn.py -b pcbs/${board}.kicad_pcb -o pcbs/${board}.dsn    
    ...
    if [ -e pcbs/${board}.ses ]; then
        ...
        ${container_cmd} run ${container_args} ${kicad_auto_image} python3 kibot/import_ses.py -b pcbs/${board}.kicad_pcb -s pcbs/${board}.ses -o pcbs/${board}_autorouted.kicad_pcb
